...
const styles = StyleSheet.create({
  ...
  errText: { fontFamily: "Tajawal_700Bold", fontSize: 13, color: "#991B1B", textAlign: "right", lineHeight: 20 },
  stackText: { fontFamily: "Tajawal_400Regular", fontSize: 10.5, color: "#666", textAlign: "right", lineHeight: 16 },
